...
targets <- read.metharray.sheet("./idat", pattern = "SampleSheet.csv")
...
write.table(array_type, "./results/array_type.csv",
  sep = ",",
  row.names = FALSE,
  col.names = "array_type",
  quote = FALSE
)
...
png("./results/mean_detection_pvals.png",
...
png("./results/bisulfite_conversionII.png",
...
png("./results/beta_density.png", width = 7, height = 5, units = "in", res = DPI)
...
write.csv(bVals_df_fin, file = "./results/bval_data.csv", row.names = FALSE)
